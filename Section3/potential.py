...
class Planner:
    ...
    def run(self, x_start, axes=None):
        ...
        """
        # Do not create a new figure/axes by default; plotting should be
        # performed by the caller. If an axes is provided, it may be used
        # by plotting calls inside this method.
